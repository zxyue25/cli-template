...
截图为证（三个都是本人写的），指路[一个将私有源npm包处理为离线包的自动化工具](https://juejin.cn/post/6985573103615098917)
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/779f7f96ddfb4f9fb389060e0f64906e~tplv-k3u1fbpfcp-watermark.image?)
